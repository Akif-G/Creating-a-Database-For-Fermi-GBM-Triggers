...
try:
    c.execute('''CREATE TABLE explored_data (time_mjd,time_iso, time_met,json_raw)''')
...
for i in range(len(allTimes)):
    c.execute('INSERT INTO explored_data VALUES (?,?,?,?)',(asTrigtimes[i].mjd,asTrigtimes[i].date,asTrigtimes[i].met,str(allTimes[i])))
